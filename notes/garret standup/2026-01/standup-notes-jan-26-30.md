...
| Field | Value |
|-------|-------|
| Source | https://fastbreak.atlassian.net/wiki/spaces/ASPAD/pages/952795137/Standup+Notes+-+Jan+26-30 |
| Format | confluence |
| Imported | 2025-03-03 |

---

## Sprint Work (2026-01-26)
...
- **Josh Portal Feedback**
  ...
  - Eventually need to give "power users" access to submit photos that Admins don't need to approve
